...
class Strings{static toFixed(a,b){return a.toFixed(b)}static init(){const a=navigator.userLanguage||navigator.language;a&&0===a.toLowerCase().indexOf("pt")&&(Strings.language="pt-br",document.documentElement.setAttribute("lang","pt-br"),Strings.DecimalSeparator=",",Strings.OppositeDecimalSeparator=".",Strings.AntecedentEvaluation="Antecedente vale Verdadeiro",Strings.BiconditionalElimination="Elimina\u00e7\u00e3o de Bicondicional",Strings.ConsequentEvaluation="Consequente vale Falso",Strings.ConstructiveDilemma=
"Dilema Construtivo",Strings.DestructiveDilemma="Dilema Destrutivo",Strings.DisjunctionElimination="Elimina\u00e7\u00e3o de Disjun\u00e7\u00e3o",Strings.DisjunctiveSyllogism="Silogismo Disjuntivo",Strings.HypotheticalSyllogism="Silogismo Hipot\u00e9tico",Strings.ModusPonens="Modus Ponens",Strings.ModusTollens="Modus Tollens",Strings.NegationIntroduction="Introdu\u00e7\u00e3o de Nega\u00e7\u00e3o",Strings.Simplification="Simplifica\u00e7\u00e3o",Strings.PleaseWait="Por favor, aguarde\u2026",Strings.Error=
"Erro",Strings.ICouldNotDeductAnythingElse="N\u00e3o consegui deduzir mais nada \ud83d\ude0a",Strings.False="Falso",Strings.True="Verdadeiro",Strings.New="Novo",Strings.Load="Abrir",Strings.LoadEllipsis="Abrir\u2026",Strings.Save="Salvar",Strings.SaveEllipsis="Salvar\u2026",Strings.LoadExample="Abrir Exemplo",Strings.InstallEllipsis="Instalar\u2026",Strings.WrapMode="Quebra de Linha",Strings.Edit="Edit",Strings.Delete="Excluir",Strings.Enable="Habilitar",Strings.Disable="Desabilitar",Strings.Enabled=
"Habilitado",Strings.Disabled="Desabilitado",Strings.Cancel="Cancelar",Strings.Clear="Limpar",Strings.Back="Voltar",Strings.Close="Fechar",Strings.Refresh="Recarregar",Strings.Exit="Sair",Strings.ShowNextDeduction="Mostrar Pr\u00f3xima Dedu\u00e7\u00e3o",Strings.StopDeducting="Parar Dedu\u00e7\u00f5es",Strings.FileName="Nome do Arquivo",Strings.UnknownError="Erro desconhecido",Strings.Theme="Tema",Strings.ThemeEllipsis="Tema\u2026",Strings.BrowserNotSupported="Infelizmente seu navegador n\u00e3o suporta essa funcionalidade \ud83d\ude22",
...
var b=0;do{let g=f.indexOf(";",b);g<b&&(g=f.length);var c=f.indexOf("|",b);0>c||c>=g?e.appendChild(document.createTextNode(Strings.translate(f))):(b=f.substring(b,c),c=f.substring(c+1,g),"text"==b?e.appendChild(document.createTextNode(Strings.translate(c))):e.setAttribute(b,Strings.translate(c)));b=g+1}while(b<f.length)}}}}Strings.language="en";Strings.DecimalSeparator=".";Strings.OppositeDecimalSeparator=",";Strings.Oops="Oops\u2026";Strings.AntecedentEvaluation="Antecedent evaluates as True";
Strings.BiconditionalElimination="Biconditional Elimination";Strings.ConsequentEvaluation="Consequent evaluates as False";Strings.ConstructiveDilemma="Constructive Dilemma";Strings.DestructiveDilemma="Destructive Dilemma";Strings.DisjunctionElimination="Disjunction Elimination";Strings.DisjunctiveSyllogism="Disjunctive Syllogism";Strings.HypotheticalSyllogism="Hypothetical Syllogism";Strings.ModusPonens="Modus Ponens";Strings.ModusTollens="Modus Tollens";Strings.NegationIntroduction="Negation Introduction";
...
null!==e&&(b.deleteSubset(a[d].usedVariables),e||(c=!1))}if(this.containsOppositeOperators)return!1;if(!c||!b.size)return c;a=this.axiomsOfInterest;for(let d of a.values()){b.deleteSubset(d.axiom.evaluatable.usedVariables);if(0>d.equivalence){c=!1;break}if(!b.size)break}return c?b.size?null:!0:!c}}
...
null!==e&&(b.deleteSubset(a[d].usedVariables),e&&(c=!0))}if(this.containsOppositeOperators)return!0;if(c||!b.size)return c;a=this.axiomsOfInterest;for(let d of a.values()){b.deleteSubset(d.axiom.evaluatable.usedVariables);if(0<d.equivalence){c=!0;break}if(!b.size)break}return c?c:b.size?null:!1}}
