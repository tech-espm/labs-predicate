'use strict';class Strings{static toFixed(a,b){return a.toFixed(b)}static init(){const a=navigator.userLanguage||navigator.language;a&&0===a.toLowerCase().indexOf("pt")&&(Strings.language="pt-br",document.documentElement.setAttribute("lang","pt-br"),Strings.DecimalSeparator=",",Strings.OppositeDecimalSeparator=".",Strings.AntecedentEvaluation="Avalia\u00e7\u00e3o de Antecedente",Strings.BiconditionalElimination="Elimina\u00e7\u00e3o de Bicondicional",Strings.ConsequentEvaluation="Avalia\u00e7\u00e3o de Consequente",
Strings.ConstructiveDilemma="Dilema Construtivo",Strings.DestructiveDilemma="Dilema Destrutivo",Strings.DisjunctionElimination="Elimina\u00e7\u00e3o de Disjun\u00e7\u00e3o",Strings.DisjunctiveSyllogism="Silogismo Disjuntivo",Strings.HypotheticalSyllogism="Silogismo Hipot\u00e9tico",Strings.ModusPonens="Modus Ponens",Strings.ModusTollens="Modus Tollens",Strings.NegationIntroduction="Introdu\u00e7\u00e3o de Nega\u00e7\u00e3o",Strings.Simplification="Simplifica\u00e7\u00e3o",Strings.PleaseWait="Por favor, aguarde\u2026",
Strings.Error="Erro",Strings.ICouldNotDeductAnythingElse="N\u00e3o consegui deduzir mais nada \ud83d\ude0a",Strings.False="Falso",Strings.True="Verdadeiro",Strings.New="Novo",Strings.Load="Abrir",Strings.LoadEllipsis="Abrir\u2026",Strings.Save="Salvar",Strings.SaveEllipsis="Salvar\u2026",Strings.LoadExample="Abrir Exemplo",Strings.InstallEllipsis="Instalar\u2026",Strings.WrapMode="Quebra de Linha",Strings.Edit="Edit",Strings.Delete="Excluir",Strings.Enable="Habilitar",Strings.Disable="Desabilitar",
Strings.Enabled="Habilitado",Strings.Disabled="Desabilitado",Strings.Cancel="Cancelar",Strings.Clear="Limpar",Strings.Back="Voltar",Strings.Close="Fechar",Strings.Refresh="Recarregar",Strings.Exit="Sair",Strings.ShowNextDeduction="Mostrar Pr\u00f3xima Dedu\u00e7\u00e3o",Strings.StopDeducting="Parar Dedu\u00e7\u00f5es",Strings.FileName="Nome do Arquivo",Strings.UnknownError="Erro desconhecido",Strings.Theme="Tema",Strings.ThemeEllipsis="Tema\u2026",Strings.BrowserNotSupported="Infelizmente seu navegador n\u00e3o suporta essa funcionalidade \ud83d\ude22",
Strings.UpdateAvailable="Atualiza\u00e7\u00e3o Dispon\u00edvel!",Strings.PleaseRefresh="Por favor, recarregue a p\u00e1gina para atualizar a aplica\u00e7\u00e3o \ud83d\ude0a",Strings.ConfirmQuit="Deseja mesmo sair da p\u00e1gina? Voc\u00ea perder\u00e1 o documento atual.",Strings.ConfirmClose="Deseja mesmo continuar? Voc\u00ea perder\u00e1 as altera\u00e7\u00f5es n\u00e3o salvas.",Strings.ErrorNoFile="Seu browser n\u00e3o oferece suporte a acesso avan\u00e7ado de arquivos \ud83d\ude22",Strings.ErrorFileLoad=
"Ocorreu um erro ao ler o arquivo \ud83d\ude22",Strings.ErrorFileSave="Ocorreu um erro ao gravar o arquivo \ud83d\ude22",Strings.ErrorDownload="Ocorreu um erro durante o download dos dados \ud83d\ude22",Strings.ErrorInvalidFileName="Nome de arquivo inv\u00e1lido \ud83d\ude22",Strings.ErrorInvalidChar="Caractere inv\u00e1lido: ",Strings.ErrorUnexpectedEndOfCode="Fim de c\u00f3digo inesperado.",Strings.ErrorUnexpectedEndOfCodeUnaryExpected="Fim de c\u00f3digo inesperado. Era esperado uma vari\u00e1vel, nega\u00e7\u00e3o ou (.",
Strings.ErrorUnexpectedEndOfLineUnaryExpected="T\u00e9rmino de linha inesperado. Era esperado uma vari\u00e1vel, nega\u00e7\u00e3o ou (.",Strings.ErrorEndOfLineExpected="Era esperado um t\u00e9rmino de linha.",Strings.ErrorUnexpectedOperatorUnaryExpected="Operador inesperado. Era esperado uma vari\u00e1vel, nega\u00e7\u00e3o ou (.",Strings.ErrorUnaryExpected="Caractere inv\u00e1lido encontrado. Era esperado uma vari\u00e1vel, nega\u00e7\u00e3o ou (.",Strings.ErrorClosingParenthesisExpected="Era esperado um ).",
Strings.ErrorClosingParenthesis2Expected="Era esperado um ].",Strings.ErrorClosingParenthesis3Expected="Era esperado um }.",Strings.ErrorClosingParenthesisOrOperatorExpected="Era esperado um ) ou um operador de conjun\u00e7\u00e3o, disjun\u00e7\u00e3o, implica\u00e7\u00e3o ou bicondicional.",Strings.ErrorClosingParenthesis2OrOperatorExpected="Era esperado um ] ou um operador de conjun\u00e7\u00e3o, disjun\u00e7\u00e3o, implica\u00e7\u00e3o ou bicondicional.",Strings.ErrorClosingParenthesis3OrOperatorExpected=
"Era esperado um } ou um operador de conjun\u00e7\u00e3o, disjun\u00e7\u00e3o, implica\u00e7\u00e3o ou bicondicional.",Strings.ErrorConditionalOperatorExpected="Era esperado operador de implica\u00e7\u00e3o ou bicondicional.",Strings.ErrorOperatorExpected="Era esperado um operador de conjun\u00e7\u00e3o, disjun\u00e7\u00e3o, implica\u00e7\u00e3o ou bicondicional.",Strings.ErrorVariableAlreadyAssignedToADifferentValue="Um valor diferente j\u00e1 havia sido atribu\u00eddo \u00e0 vari\u00e1vel: ",Strings.ErrorExpressionAlreadyAssignedToADifferentValue=
"Um valor diferente j\u00e1 havia sido atribu\u00eddo \u00e0 express\u00e3o: ",Strings.ErrorExpressionUsesTooManyVariables="A express\u00e3o utiliza mais de 16 vari\u00e1veis.",Strings.ErrorInconsistentAxioms="Premissas inconsistentes: ",Strings.ErrorInconsistentExpression="Express\u00e3o inconsistente: ",Strings.ErrorInconsistentExpression2=" era avaliada como ",Strings.ErrorInconsistentExpression3because=" por causa de ",Strings.ErrorInconsistentExpression3=" mas agora \u00e9 avaliada como ",Strings.ErrorTooManyVariables=
"Mais de 256 vari\u00e1veis declaradas.",Strings.ErrorUnknownVariable="Vari\u00e1vel desconhecida: ");Strings.translateChildren(document.body)}static translate(a){const b=Strings[a];return void 0!==b?b:a}static translateChildren(a){a=a.childNodes;for(let d=a.length-1;0<=d;d--){const e=a[d];if(!e.tagName)continue;e.childNodes&&e.childNodes.length&&Strings.translateChildren(e);let f;(f=e.getAttribute("title"))&&e.setAttribute("title",Strings.translate(f));if(f=e.getAttribute("data-string")){e.removeAttribute("data-string");
var b=0;do{let g=f.indexOf(";",b);g<b&&(g=f.length);var c=f.indexOf("|",b);0>c||c>=g?e.appendChild(document.createTextNode(Strings.translate(f))):(b=f.substring(b,c),c=f.substring(c+1,g),"text"==b?e.appendChild(document.createTextNode(Strings.translate(c))):e.setAttribute(b,Strings.translate(c)));b=g+1}while(b<f.length)}}}}Strings.language="en";Strings.DecimalSeparator=".";Strings.OppositeDecimalSeparator=",";Strings.Oops="Oops\u2026";Strings.AntecedentEvaluation="Antecedent Evaluation";
Strings.BiconditionalElimination="Biconditional Elimination";Strings.ConsequentEvaluation="Consequent Evaluation";Strings.ConstructiveDilemma="Constructive Dilemma";Strings.DestructiveDilemma="Destructive Dilemma";Strings.DisjunctionElimination="Disjunction Elimination";Strings.DisjunctiveSyllogism="Disjunctive Syllogism";Strings.HypotheticalSyllogism="Hypothetical Syllogism";Strings.ModusPonens="Modus Ponens";Strings.ModusTollens="Modus Tollens";Strings.NegationIntroduction="Negation Introduction";
Strings.Simplification="Simplification";Strings.PleaseWait="Please wait\u2026";Strings.Error="Error";Strings.ICouldNotDeductAnythingElse="I could not deduct anything else \ud83d\ude0a";Strings.False="False";Strings.True="True";Strings.Ln="Ln";Strings.Col="Col";Strings.Menu="Menu";Strings.New="New";Strings.Load="Load";Strings.LoadEllipsis="Load\u2026";Strings.Save="Save";Strings.SaveEllipsis="Save\u2026";Strings.LoadExample="Load Example";Strings.InstallEllipsis="Install\u2026";Strings.WrapMode="Line Wrap";
Strings.Edit="Edit";Strings.Delete="Delete";Strings.Enable="Enable";Strings.Disable="Disable";Strings.Enabled="Enabled";Strings.Disabled="Disabled";Strings.OK="OK";Strings.Cancel="Cancel";Strings.Clear="Clear";Strings.Back="Back";Strings.Close="Close";Strings.Refresh="Refresh";Strings.Exit="Exit";Strings.ShowNextDeduction="Show Next Deduction";Strings.StopDeducting="Stop Deducting";Strings.FileName="File Name";Strings.UnknownError="Unknown error";Strings.Theme="Theme";Strings.ThemeEllipsis="Theme\u2026";
Strings.BrowserNotSupported="Unfortunately, your browser does not support this feature \ud83d\ude22";Strings.UpdateAvailable="Update Available!";Strings.PleaseRefresh="Please, refresh the page to update the app \ud83d\ude0a";Strings.ConfirmQuit="Do you really want to quit? You will lose unsaved information.";Strings.ConfirmClose="Do you really want to continue? You will lose unsaved information.";Strings.ErrorNoFile="Your browser does not support advanced file access \ud83d\ude22";
Strings.ErrorFileLoad="An error occurred while reading the file \ud83d\ude22";Strings.ErrorFileSave="An error occurred while saving the file \ud83d\ude22";Strings.ErrorDownload="An error occurred while downloading data \ud83d\ude22";Strings.ErrorInvalidFileName="Invalid file name \ud83d\ude22";Strings.ErrorInvalidChar="Invalid character: ";Strings.ErrorUnexpectedEndOfCode="Unexpected end of code.";Strings.ErrorUnexpectedEndOfCodeUnaryExpected="Unexpected end of code. Variable, negation or ( expected.";
Strings.ErrorUnexpectedEndOfLineUnaryExpected="Unexpected end of line. Variable, negation or ( expected.";Strings.ErrorEndOfLineExpected="End of line expected.";Strings.ErrorUnexpectedOperatorUnaryExpected="Unexpected operator. Variable, negation or ( expected.";Strings.ErrorUnaryExpected="Invalid character found. Variable, negation or ( expected.";Strings.ErrorClosingParenthesisExpected=") expected.";Strings.ErrorClosingParenthesis2Expected="] expected.";
Strings.ErrorClosingParenthesis3Expected="} expected.";Strings.ErrorClosingParenthesisOrOperatorExpected="), conjunction, disjunction, implication or biconditional operator expected.";Strings.ErrorClosingParenthesis2OrOperatorExpected="], conjunction, disjunction, implication or biconditional operator expected.";Strings.ErrorClosingParenthesis3OrOperatorExpected="}, conjunction, disjunction, implication or biconditional operator expected.";Strings.ErrorConditionalOperatorExpected="Implication or biconditional operator expected.";
Strings.ErrorOperatorExpected="Conjunction, disjunction, implication or biconditional operator expected.";Strings.ErrorVariableAlreadyAssignedToADifferentValue="Variable already assigned to a different value: ";Strings.ErrorExpressionAlreadyAssignedToADifferentValue="Expression already assigned to a different value: ";Strings.ErrorExpressionUsesTooManyVariables="Expression uses more than 16 variables.";Strings.ErrorInconsistentAxioms="Inconsistent axioms: ";Strings.ErrorInconsistentExpression="Inconsistent expression: ";
Strings.ErrorInconsistentExpression2=" evaluated as ";Strings.ErrorInconsistentExpression3because=" because of ";Strings.ErrorInconsistentExpression3=" but now evaluates as ";Strings.ErrorTooManyVariables="More than 256 declared variables.";Strings.ErrorUnknownVariable="Unknown variable: ";class ModelObject{}
...
Rule.rules3.push(new ConstructiveDilemmaDisjunctionElimination);Rule.rules3.push(new DestructiveDilemma)}static applyRules(a,b,c,d){const e=d[c];let f=Rule.rules;for(var g=f.length-1;0<=g;g--){var h=f[g].apply(e);h&&(!0===h?a.push({rule:f[g],axioms:[e]}):b.push.apply(b,h))}f=Rule.rules2;for(g=0;g<c;g++){h=d[g];for(var l=f.length-1;0<=l;l--){var k=f[l].apply(h,e);k&&(!0===k?a.push({rule:f[l],axioms:[h,e]}):b.push.apply(b,k))}}f=Rule.rules3;for(g=0;g<c;g++)for(h=d[g],l=g+1;l<c;l++){k=d[l];for(let n=
f.length-1;0<=n;n--){const m=f[n].apply(h,k,e);m&&(!0===m?a.push({rule:f[n],axioms:[h,k,e]}):b.push.apply(b,m))}}}static applyRulesOfPendingDeductions(a,b){let c=a.length;for(let e=0;e<c;e++){var d=a[e];const f=d.rule;d=f.apply.apply(f,d.axioms);!0!==d&&(a.splice(e,1),c--,e--,d&&b.push.apply(b,d))}}toString(){return this.name}createFullExplanation(a,b,c,d){a=a+": "+b.id;c&&(a+=", "+c.id,d&&(a+=", "+d.id));return a}createExplanation(a,b,c){return this.createFullExplanation(this.name,a,b,c)}}
Rule.rules=[];Rule.rules2=[];Rule.rules3=[];Rule.nextIds=[0,0,0];class AntecedentEvaluation extends Rule{constructor(){super(Strings.AntecedentEvaluation,1)}apply(a){const b=a.evaluatable;if(b instanceof Implication){let c=b.operandA.evaluateValue();return null===c?!0:!1===c?!1:[{newEvaluatable:b.operandA,explanation:this.createExplanation(a)}]}return!1}}
...
class ConsequentEvaluation extends Rule{constructor(){super(Strings.ConsequentEvaluation,1)}apply(a){const b=a.evaluatable;if(b instanceof Implication){let c=b.operandB.evaluateValue();return null===c?!0:!0===c?!1:[{newEvaluatable:new Negation(b.operandB),explanation:this.createExplanation(a)}]}return!1}}
class ConstructiveDilemmaDisjunctionElimination extends Rule{constructor(){super(Strings.ConstructiveDilemma,3)}applyIfPossible(a,b,c){const d=a.evaluatable,e=b.evaluatable,f=c.evaluatable;let g;return d instanceof Implication&&e instanceof Implication&&!d.operandA.isEquivalent(e.operandA)&&f.isEquivalent(Disjunction.create([d.operandA,e.operandA]))?[{newEvaluatable:g=Disjunction.create([d.operandB,e.operandB]),explanation:this.createFullExplanation(g instanceof Disjunction?Strings.ConstructiveDilemma:
Strings.DisjunctionElimination,a,b,c)}]:!1}apply(a,b,c){return this.applyIfPossible(a,b,c)||this.applyIfPossible(a,c,b)||this.applyIfPossible(b,c,a)}}
class DestructiveDilemma extends Rule{constructor(){super(Strings.DestructiveDilemma,3)}applyIfPossible(a,b,c){const d=a.evaluatable,e=b.evaluatable,f=c.evaluatable;return d instanceof Implication&&e instanceof Implication&&f.isEquivalent(Disjunction.create([new Negation(d.operandB),new Negation(e.operandB)]))?[{newEvaluatable:Disjunction.create([new Negation(d.operandA),new Negation(e.operandA)]),explanation:this.createExplanation(a,b,c)}]:!1}apply(a,b,c){return this.applyIfPossible(a,b,c)||this.applyIfPossible(a,
c,b)||this.applyIfPossible(b,c,a)}}
...
d--,c.push.apply(c,e))}h=g.length;for(d=0;d<h;d++)g[d].initialize(d,g);for(d=0;d<h;d++){var f=g[d];for(e=d+1;e<h;e++)g[e].checkIfAxiomIsOfInterest(f)}for(f=0;f<h;f++)Rule.applyRules(a,c,f,g)}if(!b.length){const h=this.deductions;for(;!b.length&&h.length;){const l=h.splice(0,1)[0];if(l.error){this.error=!0;b.push({error:!0,text:l.explanation,explanation:null});break}const k=g.length,n=new Axiom(this.nextAxiomId,l.newEvaluatable);try{if(!n.initialize(k,g))continue}catch(m){throw b.push({error:!1,text:l.newEvaluatable.actualEvaluatable.toString(),
explanation:l.explanation}),m;}g.push(n);this.nextAxiomId+=2;b.push({error:!1,text:l.newEvaluatable.actualEvaluatable.toString(),explanation:l.explanation});try{for(c=0;c<k;c++)n.checkIfAxiomIsOfInterest(g[c]);Rule.applyRulesOfPendingDeductions(a,h);Rule.applyRules(a,h,k,g)}catch(m){h.push({error:!0,newEvaluatable:null,explanation:"formatMessage"in m?m.formatMessage():m.message||m.toString()});break}}}}catch(g){this.error=!0,b.push({error:!0,text:"formatMessage"in g?g.formatMessage():g.message||g.toString(),
...
e.type!==f&&(d=[f===TokenType.Conjunction?Conjunction.create(d):Disjunction.create(d)],f=e.type),d.push(Parser.parseUnary(a,b,c)),e=a.peekToken();return f===TokenType.Conjunction?Conjunction.create(d):Disjunction.create(d)}static parseConditional(a,b,c){let d=Parser.parseExpression(a,b,c);const e=a.peekToken();e&&e.isConditionalOperator&&(a.getToken(),a=Parser.parseConditional(a,b,c),d=e.type===TokenType.Implication?new Implication(d,a):new Biconditional(d,a));return d}static parseAxiom(a,b,c,d){c=
Parser.parseConditional(b,c,d);if((b=b.peekToken())&&b.type!==TokenType.EndOfLine)throw new InterpreterError(Strings.ErrorEndOfLineExpected,b.index,b.line,b.lineIndex);return new Axiom(a,c)}}
...
a.evaluatable,c=b.usedVariables,d=this.operands,e=d.length;for(var f=e-1;0<=f;f--)d[f].checkIfAxiomIsOfInterest(a);if(this.usedVariables.containsSubset(c)){for(f=e-1;0<=f;f--){var g=d[f].isEquivalentSomehow(b);if(g){this.axiomsOfInterest.set(a.id,{operands:[d[f]],equivalence:g,axiom:a});return}}if(!(2>e)){d=d.slice();for(f=e-1;0<=f;f--)d[f].usedVariables.intersects(c)||d.splice(f,1);e=d.length;if(!(2>e)){f=this instanceof Conjunction?Conjunction.create:Disjunction.create;g=e;--e;var h=Array(g),l=
new IdSet;for(let m=2;m<=g;m++){for(var k=m-1;0<=k;k--)h[k]=k;do{l.clear();for(k=m-1;0<=k;k--)l.addSubset(d[h[k]].usedVariables);if(l.containsSameElements(c)){k=Array(m);for(var n=m-1;0<=n;n--)k[n]=d[h[n]];if(n=f(k,!0).isEquivalentSomehow(b)){this.axiomsOfInterest.set(a.id,{operands:k,equivalence:n,axiom:a});return}}}while(this.generateNextSequence(h,e,m))}}}}}}collectVariables(a){const b=this.operands;for(let c=b.length-1;0<=c;c--)b[c].collectVariables(a)}getAxiomOfInterest(a){return this.axiomsOfInterest.get(a.id)||
null}}
...
class Conjunction extends Connective{static create(a,b){a=new Conjunction(a,b);return 1===a.operands.length?a.operands[0]:a}constructor(a,b){super(a,b,TokenStrings.ConjunctionSpace,Conjunction)}evaluateEquivalence(){const a=this.operands;for(let b=0;b<a.length;b++)if(!a[b].evaluateEquivalence())return!1;return!0}evaluateValueInternal(){var a=this.operands;const b=this.usedVariables.createIdSet();let c=!0;for(let d=a.length-1;0<=d;d--){const e=a[d].evaluateValue();null!==e&&(b.deleteSubset(a[d].usedVariables),
e||(c=!1))}if(!c||!b.size)return c;a=this.axiomsOfInterest;for(let d of a.values()){b.deleteSubset(d.axiom.evaluatable.usedVariables);if(0>d.equivalence){c=!1;break}if(!b.size)break}return c?b.size?null:!0:!c}}
class Disjunction extends Connective{static create(a,b){a=new Disjunction(a,b);return 1===a.operands.length?a.operands[0]:a}constructor(a,b){super(a,b,TokenStrings.DisjunctionSpace,Disjunction)}evaluateEquivalence(){const a=this.operands;for(let b=0;b<a.length;b++)if(a[b].evaluateEquivalence())return!0;return!1}evaluateValueInternal(){var a=this.operands;const b=this.usedVariables.createIdSet();let c=!1;for(let d=a.length-1;0<=d;d--){const e=a[d].evaluateValue();null!==e&&(b.deleteSubset(a[d].usedVariables),
e&&(c=!0))}if(c||!b.size)return c;a=this.axiomsOfInterest;for(let d of a.values()){b.deleteSubset(d.axiom.evaluatable.usedVariables);if(0<d.equivalence){c=!0;break}if(!b.size)break}return c?c:b.size?null:!1}}
...
this.evaluatable.evaluateValue();return null===a?null:!a}get usedVariables(){return this.evaluatable.usedVariables}get sortedVariables(){return this.evaluatable.sortedVariables}}
...
(a+=".txt");BlobDownloader.download(a,new Blob([new Uint8Array([239,187,191]),b],{type:"text/plain;charset=utf-8"}));$("#modalSave").modal("hide")}}}static loadExample(){}static install(){document.getElementById("editorActionInstallSeparator").style.display="none";document.getElementById("editorActionInstallItem").style.display="none";if(UI.installationPrompt){try{UI.installationPrompt.prompt()}catch(a){}UI.installationPrompt=null}}static toggleWrapMode(a){UI.wrapMode=!UI.wrapMode;a&&(UI.wrapMode?
localStorage.setItem("wrapMode","1"):localStorage.removeItem("wrapMode"));UI.editorActionToggleWrapModeIcon.className=UI.wrapMode?"fa fa-margin fa-check-square-o":"fa fa-margin fa-square-o";UI.editSession.setUseWrapMode(UI.wrapMode);UI.stepSession.setUseWrapMode(UI.wrapMode)}static showModalTheme(){UI.modalThemeSelect.value=UI.theme;$("#modalTheme").modal({keyboard:!0,backdrop:!0})}static setTheme(){UI.theme=UI.modalThemeSelect.value;localStorage.setItem("theme",UI.theme);UI.editor.setTheme(UI.theme);
UI.fixDarkTheme();$("#modalTheme").modal("hide")}}UI.btnStep=document.getElementById("btnStep");UI.btnStop=document.getElementById("btnStop");UI.modalSaveFileName=document.getElementById("modalSaveFileName");UI.modalSaveOk=document.getElementById("modalSaveOk");UI.editorActionToggleWrapModeIcon=document.getElementById("editorActionToggleWrapModeIcon");UI.modalThemeSelect=document.getElementById("modalThemeSelect");UI.editorActionFileLoad=document.getElementById("editorActionFileLoad");UI.editor=window.ace.edit("editor");
UI.installationPrompt=null;UI.loading=!1;UI.stepping=!1;UI.steppingFinished=!1;UI.init();
