...
Strings.ErrorUnexpectedEndOfLineUnaryExpected="T\u00e9rmino de linha inesperado. Era esperado uma vari\u00e1vel, nega\u00e7\u00e3o ou (.",Strings.ErrorEndOfLineExpected="T\u00e9rmino de linha inesperado.",Strings.ErrorUnexpectedOperatorUnaryExpected="Operador inesperado. Era esperado uma vari\u00e1vel, nega\u00e7\u00e3o ou (.",Strings.ErrorUnaryExpected="Caractere inv\u00e1lido encontrado. Era esperado uma vari\u00e1vel, nega\u00e7\u00e3o ou (.",Strings.ErrorClosingParenthesisExpected="Era esperado um ).",
...
class ConstructiveDilemmaDisjunctionElimination extends Rule{constructor(){super(Strings.ConstructiveDilemma,3)}applyIfPossible(a,b,c){const d=a.evaluatable,e=b.evaluatable,f=c.evaluatable;let g;return d instanceof Implication&&e instanceof Implication&&f.isEquivalent(Disjunction.create([d.operandA,e.operandA]))?[{newEvaluatable:g=Disjunction.create([d.operandB,e.operandB]),explanation:this.createFullExplanation(g instanceof Disjunction?Strings.ConstructiveDilemma:Strings.DisjunctionElimination,a,
b,c)}]:!1}apply(a,b,c){return this.applyIfPossible(a,b,c)||this.applyIfPossible(a,c,b)||this.applyIfPossible(b,c,a)}}
