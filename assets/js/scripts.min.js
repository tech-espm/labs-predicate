'use strict';class Strings{static toFixed(a,b){return a.toFixed(b)}static init(){const a=navigator.userLanguage||navigator.language;a&&0===a.toLowerCase().indexOf("pt")&&(Strings.language="pt-br",document.documentElement.setAttribute("lang","pt-br"),Strings.DecimalSeparator=",",Strings.OppositeDecimalSeparator=".",Strings.AntecedentEvaluation="Antecedente vale Verdadeiro",Strings.BiconditionalElimination="Elimina\u00e7\u00e3o de Bicondicional",Strings.ConsequentEvaluation="Consequente vale Falso",
